...
- 严格禁止PPT：即使用户要求PPT，直接告诉用户"Agent暂不支持PPT制作"，不要发送提示词
- 如果用户说"生成PDF"，提示词中必须改为"生成Word文档"
- 如果用户说"做个PPT"，直接回复"Agent暂时不支持PPT制作，可以帮你生成Word文档或Markdown报告"
- 绝对不要在提示词中出现"PDF格式"、"生成PDF"、"PPT"、"演示文稿"等字样
